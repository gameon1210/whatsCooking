...
version: 1.1.0
generated_utc: 2026-04-15T12:21:03Z
---
...
- Family preference learning in MVP is household\-level, not deep per\-person modeling.
...
- Meal history with filtering by meal type and date grouping.

- Soft feedback signals such as Make again, Kids liked, Good for tiffin, Too much work, and Not a hit.
...
The MVP is complete when a new user can onboard quickly, log meals with very little effort, view recent meal history, and receive 3–5 credible suggestions that become modestly more relevant through recency and feedback signals.
...
- Top 3–5 meal suggestions for the selected context.
...
- The app shall show no fewer than three and no more than five suggestions by default.
...
- The app shall support filtering by meal type.
...
14. System generates candidate meals, ranks them, and displays the top 3–5.
...
| Suggestion list | Must show 3–5 cards with meal name, short reason, and primary action. | Keep visually calm and scannable. |
...
- The app returns 3–5 context\-appropriate recommendations with short reasons.
